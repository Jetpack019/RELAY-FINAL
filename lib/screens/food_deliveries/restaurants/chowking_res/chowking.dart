...
class Chowking extends StatefulWidget {
  final FoodDeliver chowking;
  Chowking({required this.chowking});

  @override
  State<Chowking> createState() => _ChowkingState();
}

class _ChowkingState extends State<Chowking> {
  String orderRestaurant_Location = 'Chowking';
  @override
