...
class McDonalds extends StatefulWidget {
  final FoodDeliver mcDonald;
  McDonalds({Key? key, required this.mcDonald});
...
class _McDonaldsState extends State<McDonalds> {
  ...
  Widget build(BuildContext context) {
    String orderRestaurant_Location = 'Mc Donalds';
    return Scaffold(
      appBar: AppBar(
        toolbarHeight: 160,
