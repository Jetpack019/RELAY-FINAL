...
class StarBucks extends StatefulWidget {
  final FoodDeliver starbucks;
  StarBucks({required this.starbucks});
...
class _StarBucksState extends State<StarBucks> {
  ...
  Widget build(BuildContext context) {
    String orderRestaurant_Location = 'StarBucks';
    return Scaffold(
      appBar: AppBar(
        toolbarHeight: 160,
              ...
              IconButton(
                onPressed: () {
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (context) =>
                          RouteRestaurant(food_deliver: widget.starbucks),
                    ),
                  );
                },
                color: Colors.black,
